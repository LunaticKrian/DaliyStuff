...
.qs {
  ...
  /* 英文/数字走 Inter（非像素），中文回退 Ark Pixel（像素）—— 仅中文保持像素风 */
  font-family: 'Inter', 'Ark Pixel', sans-serif;
}
...
.qs-banner { text-align: center; font-family: 'Inter', 'Ark Pixel', sans-serif; font-size: 11px; font-weight: 700;
...
.qs-name { font-family: 'Inter', 'Ark Pixel', sans-serif; font-size: 24px; font-weight: 700; color: #73eff7;
  text-shadow: 0 0 10px rgba(115, 239, 247, 0.45); margin: 0 0 4px; letter-spacing: 0.5px; word-break: break-word; }
.qs-title { font-family: 'JetBrains Mono', 'Ark Pixel', monospace; font-size: 14px; color: #f5d976; letter-spacing: 1px; }
.qs-title b { color: #f4f4f4; }
.qs-comms { display: flex; flex-wrap: wrap; gap: 2px 12px; margin: 10px 0 4px; font-family: 'JetBrains Mono', 'Ark Pixel', monospace; font-size: 13px; color: #7b8faa; }
...
.qs-panel > h2 { margin: 0; padding: 7px 11px; font-family: 'Inter', 'Ark Pixel', sans-serif; font-size: 12px; font-weight: 700;
...
.qs-q { font-family: 'JetBrains Mono', 'Ark Pixel', monospace; font-size: 10px; font-weight: 500; color: #41a6f6; flex: 0 0 34px; padding-top: 2px; }
...
.qs-entry .date { color: #f5d976; font-family: 'JetBrains Mono', 'Ark Pixel', monospace; font-size: 14px; white-space: nowrap; }
...
.qs-awards .a .yr { color: #f5d976; font-family: 'JetBrains Mono', 'Ark Pixel', monospace; font-size: 14px; float: right; }
</style>
